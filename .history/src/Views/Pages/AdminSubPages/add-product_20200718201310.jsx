...
import { Form, Row, Col, Upload, Avatar } from "antd";
...
import { UserOutlined, NumberOutlined, PlusOutlined } from "@ant-design/icons";
        ...
        <Row gutter={[{ xs: 0, sm: 48 }, 16]} type="flex" justify="center">
          <Col md={12} sm={18} xs={24}>
            <Upload
              ...
              action="https://api.cloudinary.com/v1_1/osamaasif/image/upload"
