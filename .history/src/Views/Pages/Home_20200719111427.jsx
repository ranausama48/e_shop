        ...
        {state ? (
          state.map((data, index) => (
            <Col lg={8} sm={13} xs={24} key={index}>
              ...
              >
                <div className="p-10">
                  <Typography as="p" color="red" align="left">
                  ...
                  <Typography
                    ...
                    align="center"
                  />
                  <Typography as="h4" color="red" align="center">
                    {data.desc}
                  </Typography>
                  <Typography as="h2" color="red" align="center">
                    {data.product_price}
                  </Typography>

                  <Typography as="p" color="red" align="right">
