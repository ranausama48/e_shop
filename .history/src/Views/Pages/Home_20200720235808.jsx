      ...
      <Grid>
        <Row type="flex" justify="space-between" align="middle">
          <Col md={12}>
            ...
            <Typography color="rgba(52, 59, 92, 0.7)" as="h5">
              Eshop is the Pakistan’s first marketplace providing you best sales
              and deals from all over the top brands of Pakistan. Search your
              most favourite items now and Get upto 70% off on flat items
        ...
        <div>
          <Row type="flex" justify="center">
            <Col md={16}>
              <Typography align="center" as="h2" color="#343b5c" weight="bold">
                Top Brands on Eshop
              </Typography>
              <Typography align="center" color="rgba(52, 59, 92, 0.7)" as="h6">
