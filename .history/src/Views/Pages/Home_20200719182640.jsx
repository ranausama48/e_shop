        ...
        <Grid>
          <Row type="flex" justify="space-between" align="middle">
            <Col md={8}>
              ...
              <Typography>
                Saleonbrands.pk is the Pakistan’s first marketplace providing
                you best sales and deals from all over the top brands of
                Pakistan. Search your most favourite items now and Get upto 70%
                off on flat items including clothing, jewellery, makeup and foot
                wears.
              </Typography>
            </Col>
